...
export class AbonoDAO {
    ...
    public async create(abono: Abono, funcionarioLogado: Funcionario): Promise<Abono> {
        ...
        const doc: OptionalId<Document> = {
            idRegistro: abono.idRegistro,
            matricula: abono.matricula,
            codDisciplina: abono.codDisciplina,
            dia: abono.dia,
            horasAbonadas: abono.horasAbonadas,
            motivo: abono.motivo,
    ...
    private toAbono(doc: any): Abono {
        ...
        abono.idRegistro = doc.idRegistro;
        abono.matricula = doc.matricula;
        abono.codDisciplina = doc.codDisciplina;
        abono.dia = new Date(doc.dia);
        abono.horasAbonadas = doc.horasAbonadas;
    ...
    public async findByField(field: string, value: any): Promise<Abono[]> {
        ...
        const allowedFields = ["_id", "idRegistro", "matricula", "codDisciplina"];
